...
class MorphFSM(object):
    ...
    def generate(tokens):
        ...
        # қайырым сөзі жалғыз тұрса, оны өзгертпей қайтарамыз
        ...
        # септікті етістіктің меңгеруі мен маркер шешеді
        noun_out = None
        if nouns:
            n = nouns[0]
            if whs:
        ...
        # сөз тәртібі: бастауыш, толықтауыш, сұраулы сөз, баяндауыш
        parts = []
        if subject:
